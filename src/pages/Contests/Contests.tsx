...
import contestImgMobile from "../../images/svg/frame.svg";
...
const faqs: IFaq[] = [
  {
    ...
    answer:
      "Оценка работ осуществляется по следующим критериям:  оригинальность, техническое мастерство, соответствие теме и т. д.",
  },
  {
    question:
      "Могу ли я участвовать, если не соответствую возрастным ограничениям?",
    answer:
      "Оценка работ осуществляется по следующим критериям:  оригинальность, техническое мастерство, соответствие теме и т. д.",
  },
  {
    question:
      "Что делать, если у меня возникли проблемы с регистрацией/отправкой работ/получением приза и т. д.?",
    answer:
      "Оценка работ осуществляется по следующим критериям:  оригинальность, техническое мастерство, соответствие теме и т. д.",
  },
  {
  ...
  {
    question:
      "Могу ли я участвовать, если не являюсь жителем определенной страны или региона?",
    answer:
      "Оценка работ осуществляется по следующим критериям:  оригинальность, техническое мастерство, соответствие теме и т. д.",
  },
  {
  ...
  return (
    <div className="page">
      <div className={styles.images}>
        <img src={contestImg} alt="" className={styles.image} />
        <img src={contestImgMobile} alt="" className={styles.imageMobile} />
      </div>
      <div className="content_after_image">
        <div className={`${styles.contests_header} justify_content_SB`}>
          <h2>Все конкурсы</h2>
          <div className={styles.counter}>{contests.length}</div>
        </div>
        ...
        <div className={styles.faq}>
          {faqs.map((faq, index) => (
            <div key={index} className={styles.faq_question}>
              ...
              {openQuestions[index] && (
                <div className={styles.faq_hiddenAnswer}>{faq.answer}</div>
              )}
            </div>
          ))}
        </div>
