...
//@ts-ignore
            ...
            <section className={`${styles.bottom_text}`}>
                <p>
                    Добро пожаловать на спортивный детский сайт ФК «Рубин»! Ведите спортивный дневник школьника, участвуйте в детских интерактивных конкурсах и получите возможность выиграть атрибутику, сувениры, возможность вывести игрока на поле, посетить базу «Рубина» или стадион Ак Барс Арена, тренировку команды, а также позвать игрока в свою школу. Заполняйте дневник школьника и сможете получить видеозвонок от игрока команды. Спортивный сайт поможет тебе вырасти настоящим футболистом!
                </p>
            </section>
        </div>
    );
