    ...
    <div className="authBlock">
      <div className="authBlock__text gap-16">
        ...
        <p className="authBlock__paragraph">
          Войдите в свой профиль, чтобы продолжить пользоваться всеми функциями
          сайта и получать актуальную информацию.
        </p>
      </div>
      <div className="authBlock__form">
        <h2 className="authBlock__h2">Вход</h2>
        <form onSubmit={handleSubmit} className="authBlock__form_block">
          <div className="authBlock__form_inputs">
            ...
            <Link to="/restore">
              <div className="authBlock__form_restore">Восстановить пароль</div>
            </Link>
          </div>
