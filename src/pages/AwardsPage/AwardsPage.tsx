...
const awards = [
  {
    name: "Обладатель Суперкубка России",
    years: [2010, 2012],
    icon: "/images/russia-super-cup.svg",
  },
  {
    name: "Двухкратный чемпион России",
    years: [2008, 2009],
    icon: "/images/russia-league.svg",
  },
  {
    name: "Обладатель Кубка России",
    years: ["2011/2012"],
    icon: "/images/russia-cup.svg",
  },
  {
    name: "Победитель Первой лиги",
    years: [2002, 2023],
    icon: "/images/russia-first-league.svg",
  },
  { name: "Победитель Кубка Содружества", years: [2010] },
  { name: "Четверть-финалист Лиги Европы УЕФА", years: ["2012/2013"] },
  {
    name: "Участник группового этапа Лиги Чемпионов УЕФА",
    years: [2009, 2010],
  },
              ...
              awards.map((award, index) => (
                <div key={award.name + index} className={styles.award}>
                  <img
                    ...
                    alt=""
                  />
                  <div className={styles.award__years}>
                    {award.years.join(", ")}
                  </div>
