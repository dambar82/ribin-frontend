...
const SinglePhotoGalleryPage = () => {
  ...
  const gallery = useSelector(
    (state: RootState) => state.photoGallery.photoGalleryData
  );
      ...
      <div className={styles.photoGallery}>
        <div className={styles.photoGallery__header}>
          ...
          <div className={styles.photoGallery__info}>
            <div className={styles.photoGallery__date}>
              {gallery?.publishDate}
            </div>
            <div className={styles.photoGallery__tag}>
              #{gallery?.sectionName}
            </div>
            <div className={styles.photoGallery__qty}>
              <img src={photoIcon} alt="" />
              <span>
                {gallery?.photos ? gallery?.photos.length : 0} фотографий
              </span>
            </div>
          </div>
        </div>
        ...
        >
          <div className={styles.photogallery_slide}>
            <img
              src={
                gallery?.photos?.find((el) => el.id === activePhoto)
                  .imagePreview
              }
              alt="#"
            />
