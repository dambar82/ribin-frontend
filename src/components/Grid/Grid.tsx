      ...
      {totalPages > 1 && (
        <div className="grid__controls">
                  ...
                  return (
                    <li
                      ...
                      className={`pagination__item ${
                        item === "..." ? "pagination__item--ellipsis" : ""
                      }`}
                    >
                      <button
          ...
          <div className="grid__buttons">
            {currentPage > 1 && (
              <button
                className="grid__button grid__button--prev button button--black"
                type="button"
            ...
            {currentPage !== totalPages && (
              <button
                className="grid__button grid__button--next button button--black"
                type="button"
                onClick={() => changePage(currentPage + 1)}
              >
