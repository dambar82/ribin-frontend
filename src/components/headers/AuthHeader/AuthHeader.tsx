...
const AuthHeader = () => {
  ...
  const toggleSubMenu = (menuName: string, event: React.MouseEvent) => {
    ...
    setActiveSubMenu((prevMenuName) =>
      prevMenuName === menuName ? null : menuName
    );
  };
  ...
  const handleClickOutside = (event) => {
    if (
      activeSubMenu &&
      (!profileSubMenuRef.current ||
        !profileSubMenuRef.current.contains(event.target)) &&
      (!rubinLifeSubMenuRef.current ||
        !rubinLifeSubMenuRef.current.contains(event.target)) &&
      (!clubActivitiesSubMenuRef.current ||
        !clubActivitiesSubMenuRef.current.contains(event.target))
    ) {
    ...
    <>
        ...
        <div className={`${styles.authHeader_up}`}>
          ...
          {user && (
            ...
            >
              ...
              {activeSubMenu === "profile" && (
                <div
                  className="profile_button_subMenu"
      ...
      <div
        className={classNames(
          styles.authHeader_menu,
          activeMenu ? styles._active : ""
        )}
        ref={menuRef}
      >
        ...
        <div
          ref={rubinLifeSubMenuRef}
          className={styles.menuLink}
          onClick={(event) => toggleSubMenu("rubinLife", event)}
        >
          <div>
            Жизнь “Рубина”
        ...
        <div
          ref={clubActivitiesSubMenuRef}
          className={styles.menuLink}
          onClick={(event) => toggleSubMenu("clubActivities", event)}
        >
          <div>
            Активности
